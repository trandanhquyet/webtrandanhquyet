...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Trang1.html">
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css"><script src="./https///maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
    <script src="./js/jq/ery-1.11.1.min.js"></script>
<style>
		body {

			background: url(image/page.jpg);
...
/*anh dong*/
					...
					<div class="container" >
		               ...
		               <div class="content">
							...
							<button class="button" style="vertical-align: middle;"><span><a href="Trang 1.php"> >> Xem Tiếp  </a></span></span></button>
						...
						<div class=" item">						
							...
							<button class="button" style="vertical-align: middle;"><span><a href="Trang 1.php"> >> Xem Tiếp </a></span></button>
							</div>
				...
				<div class=" item">						
					...
					<div class="phantrang">
						<div class="phansotrang"> 
							<li><a href="Trang 1.php" class="phansotrang">  << Trước  </a></li>
							<li><a href="Trang 1.php" class="phansotrang "> 1  </a></li>
							<li><a href="Trang 1.php" class="phansotrang action"> 2 </a></li>
							<li><a href="Trang 1.php" class="phansotrang"> 3  </a></li>
							<li><a href="Trang 1.php" class="phansotrang"> 4  </a></li>
							<li><a href="Trang 1.php" class="phansotrang"> Sau >>  </a></li>
